        ...
        >
            ...
            <section className="bg-white py-16 lg:py-24">
                <Container>
                    <SectionHeading
                        className="mb-8"
                        title="Built on the platform and technology that powers the web"
                        subtitle="The same trusted, modern stack behind the apps you rely on."
                    />
                    <div
                        className="flex flex-wrap items-center justify-center gap-8 lg:gap-12"
                        data-reveal-stagger="true"
                    >
                        {technologies.map(({ name, color, path }) => (
                            <div key={name} className="flex flex-col items-center gap-3">
                                <svg className="h-12 w-12" viewBox="0 0 24 24" fill={color} aria-hidden="true">
                                    <path d={path} />
                                </svg>
