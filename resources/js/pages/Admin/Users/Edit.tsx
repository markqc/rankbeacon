...
import type { AdminUser, PageProps, Role } from '../../../types';
...
export default function Edit() {
    ...
    function toggleStatus() {
        ...
        router.patch(`/admin/users/${user.id}/toggle-status`, { status: nextStatus });
    }
        ...
        <AdminLayout title="Edit User">
            <div className="mx-auto max-w-2xl space-y-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-bold text-navy-950">Edit user</h1>
